...
class ServiceState extends State<ServicePage> {
  ...
  List servicesList = [
    [Icons.settings, 'Kompa Ban', ServicePage()],
    [Icons.settings, 'Tambal Ban', ServicePage()],
    [Icons.settings, 'Ganti Oli / Pelumas', ServicePage()],
    [Icons.settings, 'Isi Bahan Bakar', ServicePage()]
  ];
                                ...
                                children: <Widget>[
                                  Container(
                                    ...
                                    child: DropdownButton<String>(
                                      ...
                                      items: <String>['Mobil', 'Motor', 'Truck', 'Bus', 'Minibus'].map((String value) {
