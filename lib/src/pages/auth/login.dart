        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              margin:
                  EdgeInsets.only(top: 20, bottom: loginLoadingState ? 10 : 0),
              child: loginLoadingState
                      ...
                      onPressed: () {
                        ...
                        Timer(Duration(milliseconds: 500), () {
                          setState(() {
                            ...
                            User? existUser = userDatabase
                                .getUserByUsername(usernameController.text);

                            if (existUser != null &&
                                passwordController.text == existUser.password) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                    content: Text(
                                        'Selamat datang ${existUser.name}')),
                              );
